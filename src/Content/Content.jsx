    ...
    <div className={`content ${DarkTheme && "dark"}`}>
      <div className="row header">
        ...
        <svg
          ...
          style={{ fill: "#ffffff", width: "193%", height: 500 }}
        >
          <path
      ...
      <div className="row tall-square">
        ...
        <span className="tools-section">Frequency Used</span>
        ...
        <span className="tools-section__">More Tools</span>
        <div className="tools">
        ...
        <span className="tools-section__">Advanced Tools</span>
        <div className="tools">
      ...
      <div className="row tall-square inv-bg">
        ...
        <div className="admin">
          ...
          <div className="info">
            ...
            <span className="admin-about">Full-Stact & Contet Creator</span>
          </div>
        ...
        <section>
          ...
          <div className="summary">
            ...
            <span className="summary-info">
              Lorem ipsum, dolor sit amet consectetur elit. Dolor assumenda
              repudiandae aspernatur nemi mollitia, at ab cupiditate non nam.
              Officiis.
            </span>
          </div>
